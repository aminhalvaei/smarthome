...
urlpatterns = [
    ...
    path("insulation-levels/", InsulationLevelList.as_view(), name="insulation-levels-list"),
    path("insulation-levels/<int:pk>", InsulationLevelDetail.as_view(), name="insulation-levels-detail"),
